            ...
            configs: vec![
                ...
                super::Config {
                    ...
                    limits: vec![
                        ...
                        super::Limits::Gpu(super::GpuLimit::GenericAMD(super::GenericGpuLimit {
                            fast_ppt: Some(super::RangeLimit { min: Some(1_000), max: Some(53_000_000) }),
                            slow_ppt: Some(super::RangeLimit { min: Some(1_000), max: Some(43_000_000) }),
                            ppt_step: Some(1_000_000),
                            tdp: Some(super::RangeLimit { min: Some(1_000), max: Some(43_000) }),
                            tdp_step: Some(1_000),
